...
const DAY = 86400000;
const STORAGE_KEY = 'pixshaft-referral-prototype-v3';
const tasks = [
  {id:'invite', title:'邀请首位好友', category:'好友邀请', tag:'7 天 PRO', days:7, plan:'PRO', icon:'user', color:'lime', description:'好友安装并完成使用要求后，双方各获 7 天 PRO。', target:1, caption:'完成使用要求的好友', steps:['把 Pixiv-Shaft 专属邀请入口分享给一位还没用过 App 的朋友。','好友安装 App、登录并主动绑定邀请，在 7 天内于两个不同自然日使用核心功能；至少完成一次收藏。','系统验证通过后，你与好友各获得一张 7 天体验卡。'], condition:'仅限首次有效邀请。好友无需付费；每位新用户只能绑定一位邀请人。仅复制链接或下载未使用不算完成。'},
  {id:'recommend', title:'发布 App 推荐帖', category:'内容推荐', tag:'7 天 PRO', days:7, plan:'PRO', icon:'stack', color:'', description:'发布使用体验，附 App 截图和下载入口。审核通过可获 7 天 PRO。', target:1, caption:'App 推荐帖审核', steps:['在允许推广的社交平台或公开社区，发布一篇 Pixiv-Shaft App 推荐帖。','包含 App 名称、至少 100 字真实使用体验、1 张 App 功能截图，以及官方下载安装入口或专属邀请入口。','说明参与推荐活动可获得体验卡，提交帖子公开链接。审核通过即可领取，无点赞或粉丝数门槛。'], condition:'审核重点是 App 介绍是否真实、下载入口是否有效、推荐帖是否原创且公开可访问。可用官方产品素材配合个人体验；预计 2 个工作日内反馈。'},
  {id:'circle', title:'邀请 3 位活跃好友', category:'持续使用', tag:'7 天 MAX', days:7, plan:'MAX', icon:'heart', color:'blue', description:'3 位新用户均达到持续活跃要求后，可获 7 天 MAX。', target:3, caption:'好友达成持续活跃', steps:['通过专属邀请入口，邀请 3 位不同的新用户安装 App 并完成有效体验。','每位好友在加入后的前 14 天内，至少 3 个不同自然日使用核心功能，且有 1 天发生在第 8–14 天。','3 位好友均达标后，领取一张 7 天 MAX 体验卡。'], condition:'首位有效邀请可计入本任务，但需额外满足持续活跃条件。本期仅可完成一次。'},
  {id:'tutorial', title:'发布 App 使用教程', category:'使用教程', tag:'7 天 MAX', days:7, plan:'MAX', icon:'play', color:'peach', description:'以图文或视频介绍安装与操作步骤。审核通过可获 7 天 MAX。', target:1, caption:'App 教程审核', steps:['介绍 Pixiv-Shaft 的适用场景、下载安装步骤，以及一项核心功能的操作过程。','发布原创图文（至少 300 字与 3 张 App 操作截图），或不少于 60 秒的 App 实操视频。','附官方下载安装入口或专属邀请入口，说明活动奖励关系，提交公开链接等待审核。'], condition:'不限平台，不要求正面评价或点赞数。教程必须真实可复现，与 App 推荐帖任务不得使用同一份内容。预计 2 个工作日内反馈。'}
];
...
function showRules(){openSheet(`<div class="eyebrow">PROGRAM RULES</div><h2 id="sheet-title">活动规则</h2><p class="lead">以下为提议的运营规则，供设计评审确认；原型中的数据和权益均为演示。</p><ul class="rules-list"><li><strong>体验时长</strong>所有任务奖励均为 7 × 24 小时，按任务发放 PRO 或 MAX 体验卡。卡片领取后 30 天内激活；过期不自动激活。已激活卡不可转赠。</li><li><strong>领取次数</strong>首位好友安装并完成有效体验，奖励 7 天 PRO；App 推荐帖奖励 7 天 PRO；3 位好友持续活跃奖励 7 天 MAX；App 上手教程奖励 7 天 MAX。本期邀请人最多获 28 天；每位受邀新用户另获一次 7 天 PRO。首位好友可计入持续活跃任务，同一份 App 推荐内容不可重复提交。</li><li><strong>有效邀请条件</strong>新用户安装 App、登录并主动确认绑定唯一邀请人；7 天内在两个不同自然日使用核心功能，且至少收藏一次。持续活跃任务还需前 14 天内活跃 3 天，其中 1 天在第 8–14 天。</li><li><strong>领取与激活</strong>任务达标后卡片进入可领取状态。激活时顺延已有同档会员权益，不覆盖已付费天数；更高档会员须待可用时激活，细则正式接入时确认。不自动续费。</li><li><strong>审核与补充</strong>内容任务预计 2 个工作日内反馈；展示未通过原因并支持重新提交。无需购买、不要求好评、不以点赞数判定。推荐内容需明确介绍 Pixiv-Shaft，并附有效的官方下载安装入口或专属邀请入口。</li><li><strong>公平参与</strong>禁止自邀、批量账号、重复内容与骚扰式发布。异常邀请人工复核并提供申诉入口，不仅凭共享网络拒绝。活动规则调整只影响后续参与，不追溯已达成的合法奖励。</li></ul><button class="primary" data-action="close">了解了</button>`);}

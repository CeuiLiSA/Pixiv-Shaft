...
**PixShaft (Shaft)** is an open-source third-party Pixiv client for Android — illustrations, manga, novels, rankings, FANBOX and pixiv COMIC, all in one app. Material You, fluid, and it doesn't feel third-party at all.
...
<sub>Android 7.0+ · direct connection in mainland China · free, open source, no ads</sub>
...
<details><summary><b>Tablet support?</b></summary><br>Yes. In landscape you can enable two-pane mode: the feed in the left third, the artwork detail in the right two-thirds — tap and it opens on the right, no backing out. It's a switch; turn it off any time.</details>
...
<details><summary><b>Where do I download it?</b></summary><br>Install from <a href="https://play.google.com/store/apps/details?id=ceui.pixiv.pshaft">Google Play</a>, or grab the latest APK from <a href="https://github.com/CeuiLiSA/Pixiv-Shaft/releases/latest">GitHub Releases</a>. It's fully open source — build it yourself if you like.</details>
...
<a href="https://github.com/CeuiLiSA/Pixiv-Shaft/releases/latest">
  <img src="snap/pixshaft/cta-en.svg" alt="Start browsing Pixiv now — Google Play or GitHub Releases" width="100%">
</a>

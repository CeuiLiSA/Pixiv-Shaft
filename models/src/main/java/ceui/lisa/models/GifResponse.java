...
public class GifResponse {
    ...
    public int getDelay() {
        if (ugoira_metadata != null) {
            if (ugoira_metadata.frames != null && ugoira_metadata.frames.size() > 0) {
    ...
    public static class UgoiraMetadataBean {
        ...
        public static class ZipUrlsBean {
            /**
             * medium : https://i.pximg.net/img-zip-ugoira/img/2014/11/29/09/09/57/47297805_ugoira600x600.zip
             */

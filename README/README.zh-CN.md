...
<a href="https://pixshaft.com" title="pixshaft.com — Shaft 官网">
  <img src="../snap/pixshaft/hero-zh.svg" alt="Shaft — 把整个 Pixiv 装进口袋" width="100%">
</a>
...
[<img src="https://play.google.com/intl/en_us/badges/static/images/badges/en_badge_web_generic.png" alt="Google Play 下载" width="200">](https://play.google.com/store/apps/details?id=ceui.pixiv.pshaft)
&nbsp;&nbsp;
...
&nbsp;&nbsp;
[<img src="https://img.shields.io/badge/🌐_官网-pixshaft.com-7c5cff?style=for-the-badge" alt="官网">](https://pixshaft.com)
&nbsp;&nbsp;
[<img src="https://img.shields.io/badge/💗_赞助-爱发电-946ce6?style=for-the-badge" alt="爱发电赞助">](https://afdian.com/a/pixshaft)
...
<div align="center">
  <img src="../snap/pixshaft/capabilities-zh.svg" alt="为「逛 Pixiv」而生 — 插画、漫画、小说、排行榜、PixiVision、FANBOX、pixiv COMIC、热门标签、关注动态、动图补帧、GIF / MP4、批量下载、断点续传、以图搜图、稍后再看、本地书库、网络自检、图片加速、平板双栏、多账号、自定义主题色、深色模式、Material You" width="100%">
</div>
...
<div align="center">
  <img src="../snap/pixshaft/tech-zh.svg" alt="技术栈 — Kotlin、Material Design 3、MVVM、Retrofit 2、Room、Glide、自研 Feeds 框架、自研 witstudio、actionqueue、Cronet、Activity Embedding、Target SDK 36" width="100%">
</div>
...
[<img src="https://img.shields.io/badge/爱发电-支持_Shaft-946ce6?style=for-the-badge" alt="在爱发电支持 Shaft">](https://afdian.com/a/pixshaft)
...
<a href="https://github.com/CeuiLiSA/Pixiv-Shaft/releases/latest">
  <img src="../snap/pixshaft/cta-zh.svg" alt="现在就开始逛 Pixiv — Google Play 或 GitHub Releases" width="100%">
</a>

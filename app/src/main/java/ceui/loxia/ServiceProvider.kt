...
fun Fragment.requireAppLevelState(): AppLevelState = requireContext().appServices().appLevelState

fun FragmentActivity.requireAppLevelState(): AppLevelState = appServices().appLevelState

 ...
 * 标签 → 简介（超长折叠 #1005）；其后是懒加载的「作者往期作品」区块（issue #1005
 * 对齐插画详情；「相关作品」因 pixiv 无 novel related 端点、补水代价不值当而撤下），
 * 区块卡直接复用 [NovelFeedFragment] 的主力小说卡——收藏同步 / 屏蔽遮罩 / 长按菜单
 * 随基类一起生效；底部「开始阅读」浮动按钮。

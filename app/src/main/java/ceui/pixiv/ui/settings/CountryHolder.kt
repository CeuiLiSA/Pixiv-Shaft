...
class CountryViewHolder(bd: CellCountryBinding) : ListItemViewHolder<CellCountryBinding, CountryHolder>(bd) {
    ...
    override fun onBindViewHolder(holder: CountryHolder, position: Int) {
        ...
        binding.root.setOnClick {
            it.findActionReceiverOrNull<SelectCountryActionReceiver>()?.selectCountry(holder.country)
        }
    }
}
